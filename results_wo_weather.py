# %% [markdown]
# # Results without Weather features
...
# %%
model = pickle.load(open(os.path.join(MODELS_FOLDER, "base_elastic_net_wo_weather.pkl"), "rb"))
...
# %%
model = pickle.load(open(os.path.join(MODELS_FOLDER, "tuned_elastic_net_wo_weather.pkl"), "rb"))
...
# %%
model = pickle.load(open(os.path.join(MODELS_FOLDER, "base_decision_tree_wo_weather.pkl"), "rb"))
...
# %%
model = pickle.load(open(os.path.join(MODELS_FOLDER, "tuned_decision_tree_wo_weather.pkl"), "rb"))
...
# %%
model = pickle.load(open(os.path.join(MODELS_FOLDER, "base_random_forest_wo_weather.pkl"), "rb"))
...
# %%
model = pickle.load(open(os.path.join(MODELS_FOLDER, "tuned_random_forest_wo_weather.pkl"), "rb"))
...
# %%
model = pickle.load(open(os.path.join(MODELS_FOLDER, "base_gbt_wo_weather.pkl"), "rb"))
...
# %%
model = pickle.load(open(os.path.join(MODELS_FOLDER, "tuned_gbt_wo_weather.pkl"), "rb"))
...
# %%
model = pickle.load(open(os.path.join(MODELS_FOLDER, "base_xgboost_wo_weather.pkl"), "rb"))
...
# %%
model = pickle.load(open(os.path.join(MODELS_FOLDER, "tuned_xgboost_wo_weather.pkl"), "rb"))
